...
var defaultSettings = {
	...
	labels: {
		...
		inner: {
			...
			hideWhenLessThanPercentage: 10.1
		},
		mainLabel: {
			color: "#333333",
			font: "arial",
...
var labels = {
    ...
    var formatterContext = { section: section, sectionDisplayType: sectionDisplayType };
    	// Altered order of original javascript library to accomodate intelligent relocating of percents and values if they are too small
    	var percenthidden = null;
